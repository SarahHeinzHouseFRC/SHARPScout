...
public class DBSyncService extends Service
{
	...
	private class ProcessData extends AsyncTask<String, Integer, Integer>
	{
		...
		protected Integer doInBackground(String... params)
		{
			...
			synchronized(ScoutingDBHelper.lock)
			{
				...
				try
				{
					...
					processConfig(json.getJSONArray(CONFIGURATION_LU_Entry.TABLE_NAME));
					...
					processCycles(json.getJSONArray(FACT_CYCLE_DATA_Entry.TABLE_NAME));
					...
					processMatches(json.getJSONArray(FACT_MATCH_DATA_Entry.TABLE_NAME));
					...
					processWheelBase(json.getJSONArray(WHEEL_BASE_LU_Entry.TABLE_NAME));

					processWheelType(json.getJSONArray(WHEEL_TYPE_LU_Entry.TABLE_NAME));
		...
		protected void onPostExecute(Integer result)
		{
			...
			if(DB.debug)
			{
				Toast.makeText(getApplicationContext(), "Processed Response: " + result, Toast.LENGTH_SHORT).show();
			}
	...
	private class ChangeResponseCallback implements HttpCallback
	{
		public void onResponse(HttpRequestInfo resp)
		{
			...
			if(DB.debug)
			{
				Toast.makeText(getApplicationContext(), "Response to submission: " + resp.getResponseString(), Toast.LENGTH_SHORT).show();
			}

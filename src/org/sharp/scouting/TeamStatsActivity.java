...
import org.frc3260.aerialassist.TeamStats;
        ...
        TeamStats.TeamCallback
{
    ...
    public void onResponse(TeamStats stats)
    {
        ...
        DataActivity.mTabs.setTitle("Team " + teamId + " Info");
        Toast.makeText(getBaseContext(), "Team Info Retrieved", Toast.LENGTH_SHORT).show();
    }
